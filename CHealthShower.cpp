...
/// Executed as often as possible on idle.
/// Will ensure health bars are in proper pos of respective entity.
void CHealthShower::onTick_()
{
    for (auto entityBarPair : entityToBar_){
        Entity* e = entityBarPair.first;
        Bar* b = entityBarPair.second;
