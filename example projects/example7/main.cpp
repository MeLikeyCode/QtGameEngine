// Weather effect
//
// Welcome back! In this example, I'll show you how to add a weather effect to your game.
...
int main(int argc, char *argv[])
{
    ...
    qge::SnowWeather* snowWeather = new qge::SnowWeather();
    map->addWeatherEffect(*fogWeather);
    map->addWeatherEffect(*rainWeather);
//    map->addWeatherEffect(*snowWeather);
